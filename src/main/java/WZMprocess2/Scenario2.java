...
public class Scenario2 {
	...
	public static void startMyAssetAdministrationShell(Roboter roboter, Conveyor conveyor, Wzm wzm) {
		...
		AASDescriptor conveyorAasDescriptor = new AASDescriptor(conveyorAas, "http://localhost:4000/handson/conveyor/aas");
		SubmodelDescriptor cSensorSMDescriptor = new SubmodelDescriptor(cSensorSubModel, "http://localhost:4000/handson/conveyor/aas/submodels/Sensor");
		SubmodelDescriptor cMotorSMDescriptor = new SubmodelDescriptor(cMotorSubModel, "http://localhost:4000/handson/conveyor/aas/submodels/RMotor");
		...
		AASDescriptor roboterAasDescriptor = new AASDescriptor(conveyorAas, "http://localhost:4000/handson/roboter/aas");
		SubmodelDescriptor rMotorSMDescriptor = new SubmodelDescriptor(rMotorSubModel, "http://localhost:4000/handson/roboter/aas/submodels/RMotor");
		...
		SubmodelDescriptor wzmServiceSMDescriptor = new SubmodelDescriptor(wzmServiceSubModel, "http://localhost:4000/handson/wzm/aas/submodels/Service");
